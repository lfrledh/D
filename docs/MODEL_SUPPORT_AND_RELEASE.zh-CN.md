...
核实日期：2026-09-22。状态盘点基线 `368751084ab94a58b4d97dc96ad5c7c0948d2419`；本次复用既有证据，未重新执行全模态验收。最新I2V R9结果见[任务](tasks/D-VIDEO-I2V-01.md#r9-spec)及CURRENT_ACTIONS。本文集中消除旧指南中“待实测”的过时概括，不倒改历史。公开发行范围仍以[产品目标](PRODUCT_GOALS.zh-CN.md#发布前发布后归属2026-09-15r2026-09-15.1)为准。
...
| 首图视频：Wan-AI/Wan2.2-TI2V-5B | 隔离候选与数值/资源诊断，R9继续推进实际forward部件 | R8只过固定attention归因和三块加载；没有50步全片/画质/D适配通过。不能写源App支持I2V；R9通过范围另见任务结果 |
