...
用户已批准Wan2.1 1.3B固定完整权重/独立环境及精度验证，确认GPU串行窗口；下载/安装正在进行。已发现参考实现T5全量FP32临时膨胀、VAE 4T与官方4T−3帧语义差异；不能下载完成就宣称适配成功。媒体CPU入口先实施；普通D及源个人scheme不改。H09继续等待麦克风；HUM/歌声等路线不因视频全部功能完成而延后。
