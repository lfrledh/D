...
模型真实要求、适配支持、实测范围、硬件推荐和用户选择/准入分别表达；M4/16GiB只代表开发验收机，small/512/2048不作为产品永久上限。声明必须对应实际执行，不能静默忽略条件或改变精度。2026-09-13用户已批准[D-ALIGN-01](docs/tasks/D-ALIGN-01.md)实施，按该有限契约推进，不沿旧“下一步视频/歌声”文字自动开工。
